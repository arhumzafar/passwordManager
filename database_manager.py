...
def connect():
    try:
        connection = psycopg2.connect(user='arhum', password='arhum', host='127.0.0.1', database='password_manager')
        return connection
    except (Exception, psycopg2.Error) as error:
        print(error)


#Using the manager, enter the desired app name and ge the corresponding password.
...
#Sometimes I forget the username associated with the login.
# Enter the email and the manager will return the username. 
